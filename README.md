...
## News
- 2024.02.28 - `--multi-chars` param for multiple character names, each one will be sent to xtts, so make sure that you have such .wav files. Video, in Russian: https://youtu.be/JOoVdHZNCcE or https://t.me/tensorbanana/876
